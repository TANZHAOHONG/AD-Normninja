...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-2">View and manage all students</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500">Joined {{ $student->created_at->format('M d, Y') }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                            ...
                            No students found. <a href="{{ route('admin.students.create') }}" class="text-indigo-600 hover:text-indigo-800 font-semibold">Add your first student</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
